...
/** An {@link com.esotericsoftware.jsonbeans.ObjectMap} that also stores keys in an {@link ArrayList} using the insertion order. There is some additional overhead
 ...
 * @author Nathan Sweet */
public class OrderedMap<K, V> extends com.esotericsoftware.jsonbeans.ObjectMap<K, V> {
	...
	public OrderedMap (com.esotericsoftware.jsonbeans.ObjectMap<? extends K, ? extends V> map) {
		super(map);
		keys = new ArrayList(capacity);
	}
