...
class DepthLineShader extends Shader {
  ...
  override def init(): Unit = {
    val vert = Gdx.files.internal("shaders/depth_line_v.glsl").readString()
    val frag = Gdx.files.internal("shaders/depth_line_f.glsl").readString()
